...
function Card({ tipo, descricao, badge }) {
    const Icone = iconMap[tipo] ?? UserRound;

    return (
        <div className="bg-white rounded-2xl shadow-md p-10 w-64 h-80 flex flex-col items-center gap-5 mb-8 cursor-pointer hover:-translate-y-1 hover:shadow-lg transition-all ">
            ...
            <p className="text-xs text-gray-800 text-center leading-relaxed">{descricao}</p>
